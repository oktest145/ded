...
echo "Checking VPS"
#########################
IZIN=$(curl -sS https://gist.github.com/oktest145/2a52087df9ca7397edb3792108a8f189/raw/ip | awk '{print $4}' | grep $MYIP)
if [ $MYIP = $IZIN ]; then
...
#EXPIRED
expired=$(curl -sS https://gist.github.com/oktest145/2a52087df9ca7397edb3792108a8f189/raw/ip | grep $MYIP | awk '{print $3}')
echo $expired > /root/expired.txt
today=$(date -d +1day +%Y-%m-%d)
while read expired
do
	exp=$(echo $expired | curl -sS https://gist.github.com/oktest145/2a52087df9ca7397edb3792108a8f189/raw/ip | grep $MYIP | awk '{print $3}')
	if [[ $exp < $today ]]; then
		Exp2="\033[1;31mExpired\033[0m"
        else
        Exp2=$(curl -sS https://gist.github.com/oktest145/2a52087df9ca7397edb3792108a8f189/raw/ip | grep $MYIP | awk '{print $3}')
	fi
done < /root/expired.txt
rm /root/expired.txt
Name=$(curl -sS https://gist.github.com/oktest145/2a52087df9ca7397edb3792108a8f189/raw/ip | grep $MYIP | awk '{print $2}')
# Color Validation
DF='\e[39m'
Bold='\e[1m'
Blink='\e[5m'
